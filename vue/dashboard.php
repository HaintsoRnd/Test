        ...
        <div class="overview-boxes">
          ...
          <div class="box">
            <div class="right-side">
              ...
              <div class="number"><?php echo number_format(getCA()['prix'], 0, ',', ' ')."Ar" ?></div>
              <div class="indicator">
            ...
            <div class="sales-details">
              ...
              <ul class="details">
                ...
                <?php
                   foreach($ventes as $key => $value){
                    ?>
                    <li><a href="#"><?php echo number_format($value['prix'],0, ",", " ")."Ar" ?></a></li>
                    <?php
                   }
                ?>
            ...
            <ul class="top-sales-details">
              <?php 
                ...
                <a href="#">
                    ...
                    <span class="price"><?php echo number_format($value['prix'],0, ",", " ")."Ar" ?></span>
                </li>                    
                    <?php
                  }
              ?>
