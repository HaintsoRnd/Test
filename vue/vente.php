...
<div class="home-content">
    <div class = >
        <div class = "box">
            <form action=" <?= !empty($_GET['id'])? "/gstock/model/modifVente.php" : "/gstock/model/ajoutVente.php" ?> "  method="post">
                ...
                <input onkeyup="setPrix()" value="<?= !empty($_GET['id']) ? $article['quantite'] : "" ?>" type="number" name="quantite" id="quantite" placeholder="Saisir le nom de la quantité">

                <label for="prix">Prix</label>
                <input value="<?= !empty($_GET['id']) ? $article['prix'] : "" ?>" type="number" name="prix" id="prix" placeholder="Saisir le prix">
        ...
        <div class="box">
            <table class="mtable">
                ...
                <?php
                $vente = getVente();
                /*ty le variable asina anleh total prix rehetra*/
                $prix_total = 0;
                if(!empty($vente) && is_array($vente)){
                     foreach($vente as $key=>$value){
                        /*Affectena fotsiny izy aveo*/
                        $prix_total += $value['prix'];
                    ?>
